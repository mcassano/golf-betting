...
5. **Payouts** — Five bets run simultaneously:
   - **Days 1 & 2**: Lowest combined score across all 6 golfers wins $5 from each loser.
   ...
   - **Wild Card**: If your WC golfer wins the tournament, you collect $20 from each opponent.
